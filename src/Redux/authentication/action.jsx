...
export const getUserLoginDetails = (mobile) => (dispatch) => {
  ...
  return axios
    .get(`https://joi-mart-login-api.onrender.com/userDetails?mobile=${mobile}`)
    .then((res) => {
...
export const postNewUserLoginDetails = (data) => (dispatch) => {
  ...
  return axios
    .post(`https://joi-mart-login-api.onrender.com/userDetails`, data)
    .then((res) => {
...
export const updateUserAuthStatus = (id, isAuth) => {
  axios.patch(
    `https://joi-mart-login-api.onrender.com/userDetails/${id}`,
    isAuth
  );
};
